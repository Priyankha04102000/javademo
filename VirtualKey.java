...
public class VirtualKey {
	public static void main(String[] args) {
		...
		System.out.println("Creating the Virtual Key repository");
		System.out.println("- by Priyankha M");
	    while(true){
		 System.out.println("1.For arranging files in ascending order");
         System.out.println("2.Business level functions");
		...
		int choice = scan.nextInt();
				...
				case 2:
					...
					while (temp) {
						...
						System.out.println("2.Search required file");
						System.out.println("3.Delete required file");
						...
						case 3:
							...
							if (file2 == true) {
								...
								System.out.println("file does not exist in this");
							}
